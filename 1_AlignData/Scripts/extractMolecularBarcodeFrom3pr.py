...
while header != '':
    ...
    barcode  = totseq[-7:-1]    # assigns the 6 last nucleotide (nt) of the read sequence to the variable "barcode"
    ligation = totseq[-10:-4]    # assigns the last 3 nts of the RNA fragment and the first 3 nts of the MBC to the variable "ligation"
    seq  = totseq[:-7]         # assigns the RNA fragment sequence to the variable "seq"
    qual = totqual[:-7]        # assigns the RNA fragment PHRED quality score to the variable "qual"
