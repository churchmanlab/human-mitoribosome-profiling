...
Update 10/18/18 - Mary Couvillion
Modify for 10 nt rather than 6 nt 3' barcode
...
#for barcode in list(itertools.product(nct, repeat=14)): # MC: changed to 14 for longer barcode
...
while header != '':
    ...
    barcode  = totseq[0:4] + totseq[-11:-1]    # assigns the first 4 and last 10 nucleotide (nt) of the read sequence to the variable "barcode"
#    ligation = totseq[-14:-8]    # assigns the last 3 nts of the RNA fragment and the first 3 nts of the MBC to the variable "ligation"
    seq  = totseq[4:-11]         # assigns the RNA fragment sequence to the variable "seq"
    qual = totqual[4:-11]        # assigns the RNA fragment PHRED quality score to the variable "qual"
